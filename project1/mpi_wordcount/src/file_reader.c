...
void startReader(int my_rank, double split_size, FileInformationContainer * filesContainer, CounterContainer * entriesContainer) {
	...
	printf("rank = %d, read size= %.2f bytes, words found = %d\n", my_rank, already_read_by_me, words_found);
