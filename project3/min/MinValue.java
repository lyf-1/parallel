...
public class MinValue extends Configured implements Tool { 
	...
	public static class MapClass extends Mapper<LongWritable, Text, Text, DoubleWritable> { 
		...
		InterruptedException { 
			context.write(new Text("Min"), new DoubleWritable(minNum)); 
		} 
	} 
	...
	public static class Reduce extends Reducer<Text, DoubleWritable, Text, DoubleWritable> { 
		...
		protected void cleanup(Context context) throws IOException, 
		InterruptedException { 
			context.write(one, new DoubleWritable(minNum));
		} 
	} 
	...
	public static void main(String[] args) throws Exception { 
		...
		int res = ToolRunner.run(new Configuration(), new MinValue(), args); 
